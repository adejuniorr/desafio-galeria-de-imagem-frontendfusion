...
export const Modal = ({
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={clsx(
        "w-full h-full bg-black bg-opacity-30 overflow-y-auto overflow-x-hidden z-50 flex justify-center items-center",
        {
          fixed: imageDetailsOpen,
          hidden: !imageDetailsOpen,
        }
      )}
      onClick={(e) => {
        e.stopPropagation();
      ...
      >
        <div className="flex items-center justify-between p-4 border-b ">
          ...
          <button
            ...
            type="button"
            className="text-gray-800 bg-transparent hover:bg-gray-200 text-sm w-8 h-8 ms-auto flex justify-center items-center rounded-md"
            ...
            <div className="flex justify-between items-center gap-4 mt-6">
              ...
              <div className="flex justify-end items-center gap-4 mt-6">
                ...
                <a
                  ...
                  onClick={() => download()}
                  className="flex items-center gap-[4px] cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm px-5 py-2 text-center"
                >
                  <FaDownload />
                  Baixar
                </a>
